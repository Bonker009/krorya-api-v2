...
public class FoodServiceImpl implements FoodService {
    ...
    public List<FoodDTO> getAllFoods(int page, int size) {
        List<FoodDTO> foodList = foodDTOConvertor.toListDTO(foodRepository.getAllFoods(page, size));
        if (foodList.isEmpty()) {
...
//        if (foodRepository.getUserNameByUserId(userId) == null){
...
//        return foodDTOConvertor.toDto(foodRepository.getFoodById(id));
    }
