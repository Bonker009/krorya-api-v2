...
public class BookmarkController {
    ...
    public ResponseEntity<?> updateBookmarkedByFoodId(
        ...
        FoodDTO foodDTO = foodService.updateFoodBookmarked(foodId, bookmarked, currentUser);
    ...
    public ResponseEntity<?> updateBookmarkedByRecipeId(
        ...
        RecipeDTO recipeDTO = recipeService.updateRecipeBookmarked(recipeId, bookmarked, currentUser);
        return ResponseEntity.ok(
                ApiResponse.builder()
                        .message("bookmarked has change status successfully")
                        .payload(recipeDTO)
    ...
    @Operation(summary = "Get current user recipes by bookmarked", description = "Retrieve cuurent recipes by bookmarked")
    @GetMapping("/recipes")
