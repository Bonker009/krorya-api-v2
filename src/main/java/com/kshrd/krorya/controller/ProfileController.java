...
public class ProfileController {
    ...
    @GetMapping("/{userId}")
    public ResponseEntity<ApiResponse<AppUserDTO>> getUserByUserId(@Valid @Parameter(description = "User ID to retrieve user information", example = "d290f1ee-6c54-4b01-90e6-d701748f0851") @PathVariable UUID userId){
        AppUserDTO appUserDTO = appUserService.findUserByUserId(userId);
