...
public interface FoodRepository {
    ...
    @Results(id = "foodMapping", value = {
            ...
            @Result(column = "seller_id", property = "sellerName",
                    one = @One(select = "com.kshrd.krorya.repository.AppUserRepository.findUsernameByUserid"))
    })
    List<Food> getAllFoods(int page, int size);
...
//    boolean isFoodOwner(@Param("foodId") UUID foodId, @Param("currentUserId") UUID currentUserId);
